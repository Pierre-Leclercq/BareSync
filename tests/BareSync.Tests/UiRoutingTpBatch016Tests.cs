...
public sealed class UiRoutingTpBatch016Tests
{
    [Fact]
    public async Task TP_BATCH_016_EditDescription_UpdatesJsonAndUi()
    {
        ...
        Assert.Equal("My description", doc.RootElement.GetProperty("description").GetString());
    }
}