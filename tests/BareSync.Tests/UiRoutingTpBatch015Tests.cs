...
public sealed class UiRoutingTpBatch015Tests
{
    [Fact]
    public async Task TP_BATCH_015_RenameBatch_UpdatesName()
    {
        ...
        Assert.Equal("Renamed Batch", doc.RootElement.GetProperty("name").GetString());
    }
}